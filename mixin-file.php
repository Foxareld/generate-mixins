<?php
	...
	loop through var_name and color_hex 
	new_color = "@".var_name.":#".color_hex;
	string .= new_color
	...
	*/
	...
	//size of array, both arrays should be same size
	$arraySize = count($_POST["var_name"]);
...
use color variables properly: http://sachagreif.com/sass-color-variables/
*/
